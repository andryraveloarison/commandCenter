...
export type DashboardView = 'global' | 'projets' | 'interventions';
...
const DashboardPeriodFilter: React.FC<Props> = ({ view, setView, period, setPeriod, customStart, setCustomStart, customEnd, setCustomEnd, range }) => (
  <div style={{ display: 'flex', alignItems: 'center', gap: 12, flexWrap: 'wrap' }}>
    ...
    <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginLeft: 'auto' }}>
      ...
      {range && (
        <span style={{ fontSize: 10, fontWeight: 700, color: '#C4C9D4', fontFamily: 'monospace' }}>
